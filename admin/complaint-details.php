...
<body>
      ...
      <div class="row">
        ...
        <div class="span9">
          <div class="content">
            ...
            <input type="button" class="remove" value="Report Generation" onclick="myApp.printTable()">
            <div class="module">
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="javascript:void(0);"
                          onClick="popUpWindow('http://localhost/complaint management system/cms/admin/updatecomplaint.php?cid=<?php echo htmlentities($row['complaintNumber']); ?>');"
                          title="Update order">
                      ...
                      <td colspan="4">
                        <a href="javascript:void(0);"
                          onClick="popUpWindow('http://localhost/complaint management system/cms/admin/userprofile.php?uid=<?php echo htmlentities($row['userId']); ?>');"
                          title="Update order">
  ...
  var myApp = new function() {
    this.printTable = function() {
      var tab = document.querySelector(".module");
      tab.innerHTML;
      ...
      style = style + 'tr:nth-child(9){display: none}';
      style = style + '.remove{display: none}';
      ...
      win.document.write('<body > <h1>Report generation for Complains <br> <style><h1>{}></style>');
