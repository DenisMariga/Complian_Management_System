    ...
    <div class="container">
      ...
      <form class="form-login" name="login" method="post">
        ...
        <div class="login-wrap">
          ...
          <button class="btn btn-primary btn-block" name="submit" type="submit"><i class="fa fa-sign-in"></i>
            Login</button>
          <hr>
      </form>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <input type="text" name="contact" placeholder="contact No" autocomplete="off" class="form-control"
                required><br>
